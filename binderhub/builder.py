...
class BuildHandler(BaseHandler):
    ...
    async def get(self, provider_prefix, _unescaped_spec):
        ...
        self.build = build = BuildClass(
            ...
            extra_volume_build=self.settings['extra_volume_build'],
            extra_volume_mount_build=self.settings['extra_volume_mount_build'],
            init_container_build=self.settings['init_container_build'],
